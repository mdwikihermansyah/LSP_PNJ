...
export default function AddLembagaSertifikasi() {
  return (
    <>
      <p className="mt-3 text-xl underline text-primary-blue font-semibold">
      Tambah  Data Tempat Uji Kompetensi (TUK)
      </p>
      <form className="mt-3 flex md:flex-row gap-5 flex-col">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-row gap-5">
            <Input.Wrapper label="Desa/Kelurahan" required mt={10} className="w-full">
              <Input placeholder="" />
            </Input.Wrapper>
