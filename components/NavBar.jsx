            ...
            <div 
                ...
                >
                    <ul className="h-screen md:h-auto items-center justify-center md:flex gap-3 ">
                        <li className="pb-6 text-lg text-primary-blue py-2 md:px-6 text-center border-b-2 md:border-b-0  border-primary-blue md:hover:bg-transparent md:hover:text-primary-blue hover:text-white hover:bg-primary-blue mt-3">
